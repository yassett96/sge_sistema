...
if($VerificarExistenciaEvento == CteExisteEventoEnAñoActual){
    ...
    header('Location: ../../Vista/Participante/MiCuenta_CE.php');//Aqui lo redireccionas al lugar que quieras.    
}else{
...
<head>
    ...
    <link rel="stylesheet" href="../../Assets/css/Participante/Micuenta_SE.css">
...
<body>
  ...
  <a href='../../Controlador/General/CCerrarSesion.php'>Cerrar sesión</a>
    ...
    <div class="cuadro_fondo">
        ...
        <img src="../../Assets/imagenes/Recursos/mosaicos2.png" id="mosaicoIZQ" height="180px" width="180px">        <br>
        <br>
