...
require_once ("../../Controlador/Participante/CEvento_PCE.php");
...
if($VerificarExistenciaEvento != CteExisteEventoEnAñoActual){
    ...
    header('Location: ../../Vista/Participante/Eventos_PSE.php');//Aqui lo redireccionas al lugar que quieras.    
}else{
    ...
    <header>
        ...
        <div class="menu_general">
            <ul class="nav justify-content-end">
                ...
                <li class="nav-item"><a class="nav-link active" id="texto" href="../../Vista/Participante/Evento_PCE.php">Eventos</a></li>
        ...
        <div class="main-header">
            ...
            <nav id="nav" class="main-nav">
              <div class="nav-links">
                ...
                <a class="link-item"  href="../../Vista/Participante/Evento_PCE.php">Eventos</a>
              ...
              <div class="row">
                ...
                <div class="col-xs-6 col-md-3">
                  ...
                  <ul class="footer-links">
                    ...
                    <li><a href="../../Vista/Participante/Evento_PCE.php">Eventos</a></li>
