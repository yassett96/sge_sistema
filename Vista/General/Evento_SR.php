<?php
    require_once ("../../Controlador/General/CEvento_SR.php");
    ...
    if($VerificarExistenciaEvento == CteExisteEventoEnAñoActual){
        ...
        header('Location: ../../Vista/General/Eventos_CR.php');//Aqui lo redireccionas al lugar que quieras.    
    }else{
?>
    ...
    <header>
        ...
        <div class="menu_general">
            <ul class="nav justify-content-end">
                ...
                <li class="nav-item"><a class="nav-link active" id="texto" href="../../Vista/General/Evento_SR.php">Eventos</a></li>
        ...
        <div class="main-header">
            ...
            <nav id="nav" class="main-nav">
              <div class="nav-links">
                ...
                <a class="link-item"  href="../../Vista/General/Evento_SR.php">Eventos</a>
        ...
        <div class="row">
          ...
          <div class="col-xs-6 col-md-3">         
            ...
            <li><a href="../../index_SRSE.php">Inicio</a></li>
                <li><a href="../../Vista/General/Evento_SR.php">Eventos</a></li>
