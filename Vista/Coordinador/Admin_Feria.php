...
<head>
    ...
    <link rel="stylesheet" href="../../Assets/css/Coordinador/Admin_Feria.css">
...
<div class="card w-70">
  ...
  <button onclick="location.href='../../Vista/Coordinador/Planificacion_Feria.php'" class="btn btn-primary">Iniciar nueva feria</button>
  </div>
</div>
...
<div class="card w-70">
  ...
  <img class="card-img-top" src="../../Assets/imagenes/Recursos/Modificar.png" >
    <button href="#" class="btn btn-primary" disabled >Modificar feria actual</button>
  </div>
</div>
