...
require_once ("../../Controlador/Coordinador/CEvento_CoordinadorSE.php");
  ...
  if($vlocResultadoVerificacionExistenciaEvento == CteExisteEventoEnAñoActual){
    ...
    header('Location: ../../Vista/Coordinador/IndexCoordinadorCE.php');//Aqui lo redireccionas al lugar que quieras.    
  }else{
...
<head>
    ...
    <link rel="stylesheet" href="../../Assets/css/Coordinador/IndexCoordinadorSE.css">             
  ...
  <header>
      <div id="divPrincipalHeader">    
        ...
        <div id="divMenuDespliegue">              
          <a class="nav-link " href="../../Vista/Coordinador/MCuentaSE.php">Mi cuenta</a>
...
<div id="div_Contenedor_Noticias">
  ...
  <script src="../../Assets/js/Coordinador/IndexCoordinadorSE.js"></script>   
  <script>
