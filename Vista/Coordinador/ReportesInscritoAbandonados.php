...
$ListaComisiones = $MRep->ObtenerProyectosAbandonadosEA();

$TotalProyectos= count($ListaComisiones);
$ListaParticipantes = $MRep->ObtenerParticipantesAbandonadosEA();
...
<body>
    ...
    <h4 class="h4">Proyectos y participantes inscritos abandonados</h4>
    ...
    $(document).ready(function() {
        ...
        var table = $('#TProyectosEA').DataTable({
            ...
            buttons: [{
                    ...
                    title: 'Proyectos Que Abandonaron el Evento actual',
        ...
        table.on('click', 'tbody tr', function() {
            ...
            $.ajax({
                url: "../../Controlador/Coordinador/CCargarIntegrantesProyecto.php",
                type: "POST",
                data: {
        ...
        var table3 = $('#TParticipantesEA').DataTable({
            ...
            buttons: [{
                    extend: 'excelHtml5',
                    text: '<i class="fas fa-file-excel"></i> ',
                    title: 'Listado de Participantes que abandonaron proyecto',
                    titleAttr: 'Exportar a Excel',
                    className: 'btn btn-success'
                },
                {
