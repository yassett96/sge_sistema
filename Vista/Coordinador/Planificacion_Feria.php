...
<head>
    ...
    <link rel="stylesheet" href="../../Assets/css/Coordinador/Planificacion_Feria.css">
...
<body>
  ...
  <img class="card-img-top" src="../../Assets/imagenes/Recursos/S_DatosG.png" >
    ...
    <button onclick="location.href='../../Vista/Coordinador/PlanificacionE1.php'" class="btn btn-primary"> Agregar Datos generales</button>  </div>
</div>
...
<div class="card w-75">
  ...
  <img class="card-img-top" src="../../Assets/imagenes/Recursos/S_Comision.png" >
    ...
    <button href="#" class="btn btn-primary" disabled >Gestionar comisiones</button>
  </div>
</div>
<div class="card w-75">
  <div class="card-body- text-center">
  <img class="card-img-top" src="../../Assets/imagenes/Recursos/S_CatSub.png" >
    <!--<a href="#" class="btn btn-primary">Gestionar categorías y subcategorías</a>-->
...
<div class="card w-75">
  ...
  <img class="card-img-top" src="../../Assets/imagenes/Recursos/S_Conferencia.png" >
    ...
    <button href="#" class="btn btn-primary" disabled >Gestionar conferencias</button>
...
<div class="card w-75">
  ...
  <img class="card-img-top" src="../../Assets/imagenes/Recursos/S_Jurado.png" >
    ...
    <button href="#" class="btn btn-primary" disabled >Gestionar jurados</button>
  </div>
</div>
</div>
