...
<head>
    ...
    <link rel="stylesheet" href="../../Assets/css/Coordinador/Admin_Feria_CE.css">
    
    <title>Administracion Feria </title>
</head>
<body>
    <header>
        <div class="logo">
    ...
    <a class="nav-link active" id="texto_atras" href="../../Vista/Coordinador/AdminEventosCE.php" > << Atrás  </a>
    <h4 class="h4">Administración de evento feria</h4>
...
<div class="card w-70">
  ...
  <img class="card-img-top" src="../../Assets/imagenes/Recursos/Iniciar.png" >
  <!--<a href="../../Vista/Coordinador/Planificacion_Feria.php" class="btn btn-primary">Iniciar nueva feria</a>-->
  <button href="#" class="btn btn-primary" disabled >Iniciar nueva feria</button>
  </div>
</div>
...
<div class="card w-70">
  ...
  <div class="card-body- text-center">
  <img class="card-img-top" src="../../Assets/imagenes/Recursos/Modificar.png" >
    <!--<a href="#" class="btn btn-primary">Modificar feria actual</a>-->
    <button onclick="location.href='../../Vista/Coordinador/Planificacion_Feria_CE.php'" class="btn btn-primary">Modificar feria actual</button>
  </div>
</div>
...
<div class="card w-70">
  ...
  <div class="card-body- text-center">
  <img class="card-img-top" src="../../Assets/imagenes/Recursos/Historial.png" >
    <!--<a href="#" class="btn btn-primary">Historial de ferias</a>-->
    <button onclick="location.href='../../Vista/Coordinador/HistorialEventoFeria.php'" class="btn btn-primary">Historial de ferias</button>
  </div>
</div>
</div>
