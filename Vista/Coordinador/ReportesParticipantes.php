...
<head>
    ...
    <link rel="stylesheet" href="../../Assets/css/Coordinador/ReportesComision.css">

    <!--<link rel="stylesheet" type="text/css" href="ruta/progressbar.css">-->


    <title>Reportes Proyectos y Participantes</title>
</head>
...
<body>
    ...
    <h4 class="h4">Reportes de proyectos y participantes</h4>

    <div id="contenedor"></div>
    <div class="containerbotones">
        <div class="buttons-row">
            <button onclick="location.href='../../Vista/Coordinador/ReportesInscritoConfirmados.php'" class="button btn btnInCon" id="btnInCon">Inscritos confirmados</button>
            <button onclick="location.href='../../Vista/Coordinador/ReportesInscritoNoConfirmado.php'"class="button btn btnInNCon " id="btnInNCon">Inscritos no confirmados</button>
            <button onclick="location.href='../../Vista/Coordinador/ReportesInscritoAbandonados.php'"class="button btn btnInAba " id="btnInAba">Abandonados</button>
            <button onclick="location.href='../../Vista/Coordinador/ReportesParticipantesGenerales.php'"class="button btn btnInGenerales " id="btnInGenerales">Lista de proyectistas</button>
            <button onclick="location.href='../../Vista/Coordinador/ReportesProyetosGenerales.php'"class="button btn btnProGenerales " id="btnProGenerales">Lista de proyectos</button>
