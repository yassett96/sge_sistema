...
require_once ("../../Controlador/Coordinador/CEvento_CoordinadorSE.php");
    ...
    if($VerificarExistenciaEvento == CteExisteEventoEnAñoActual){
        ...
        header('Location: ../../Vista/Coordinador/EventoCoordinadorCE.php');//Aqui lo redireccionas al lugar que quieras.    
    }else{
...
<head>
    ...
    <link rel="stylesheet" href="../../Assets/css/Coordinador/EventoCoordinadorSE.css">

    <title>Evento Coordinador SE</title>
</head>
