...
$ListaProyectos = $MRep->ObtenerProyectosGeneralesEA();

$TotalParoyectos= count($ListaProyectos);
...
<body>
    ...
    <h4 class="h4">Lista de  proyectos en general</h4>

    <!--<div class="col-10" style="margin-left: 10%;">   clase de tabla class="table  table-hover "-->

    <h4 class="h4">Proyectos Totales <?php echo $TotalParoyectos;?></h4>
    <div id="MarcoTProyectos" class="table-wrapper-scroll-y my-custom-scrollbar-2">
        ...
        <table id="TParticipantesG" name="TParticipantesG" class="table table-bordered  display " cellspacing="0"
            ...
            <tbody>
                ...
                foreach ($ListaProyectos as $participantes) {
            ?>
                <tr>
                    <!-- <td></td>-->
    ...
    $(document).ready(function() {
        ...
        var table3 = $('#TParticipantesG').DataTable({
            ...
            buttons: [{
                    ...
                    title: 'Listado de Proyectos del Evento',
