...
if($VerificarExistenciaEvento != CteExisteEventoEnAñoActual){
    ...
    header('Location: ../../Vista/Jurado/MiCuenta_SE.php');//Aqui lo redireccionas al lugar que quieras.    
}else{
?>
...
<head>
    ...
    <link rel="stylesheet" href="../../Assets/css/Jurado/micuenta_ce.css" >
            ...
            <ul class="nav justify-content-end">                         
                ...
                <div class="dropdown">
                    ...
                    <div class="dropdown-content">
                        <a href="../../Vista/Jurado/MiCuenta_CE.php">Mi cuenta</a>
        ...
        <div class="main-header">            
            <nav id="nav" class="main-nav">
              <div class="nav-links">
                ...
                <a class="link-item"  href="../../Vista/Jurado/ResultadosEvaluaciones.ph" >Evaluaciones</a>
