...
if($VerificarExistenciaEvento == CteExisteEventoEnAñoActual){
    ...
    header('Location: ../../Vista/Jurado/MiCuenta_CE.php');//Aqui lo redireccionas al lugar que quieras.    
}else{
?>
...
<head>
    ...
    <link rel="stylesheet" href="../../Assets/css/Jurado/micuenta_se.css" >
...
<body>
        ...
        <div class="menu_general">
            <ul class="nav justify-content-end">
                ...
                <div class="dropdown-content">
                    <a href="../../Vista/Jurado/MiCuenta_SE.php">Mi cuenta</a>
        ...
        <div class="main-header">            
            <nav id="nav" class="main-nav">
              <div class="nav-links">
                ...
                <a class="link-item"  href="../../Vista/Jurado/MiCuenta_SE.php">Mi cuenta</a>
    ...
    <script type="text/javascript" src="../../Assets/js/Jurado/micuenta_ce.js"></script>
    ...
    <footer class="site-footer">
      <div class="container">
        <div class="row">
          ...
          <div class="col-xs-6 col-md-3">
            <ul class="footer-links">
            <li><a href="../../Vista/Jurado/MiCuenta_SE.php">Mi cuenta</a></li>
            </ul>
          </div>
