...
<head>
  ...
  <link rel="stylesheet" href="../../Assets/css/Jurado/ResultadosEvaluaciones.css">
...
<body>
    ...
    <h1 id="h1TextoInicial">Proyectos evaluados</h1>
    ...
    <br><br>    
      ...
      <!-- INICIO TABLA -->
      <div id="idDivTabla">
        <h2 id="idTextoTabla">Consolidado de proyectos evaluados</h2>
          ...
          <table id="idTable">
            ...
            <tbody>
              <?php 
                ...
                $vlocArrayListaProyectosEvaluados = FunObtenerListaProyectosEvaluados($vlocIdPersona);
                $vlocListaProyectos = implode(',', $vlocArrayListaProyectosEvaluados);
      ...
      <div id="idDivBotonesAcciones">
        <button class="classBotonAccion" id="idBotonGenerarGanadores">Generar ganadores</button>
        <button class="classBotonAccion" id="idBotonGenerarReporte">Generar reporte</button>
   ...
   <script src="../../Assets/js/Jurado/ResultadosEvaluaciones.js"></script>   
