...
require_once ("../../Controlador/Academico/CCuenta_SE.php");
...
if($VerificarExistenciaEvento == CteExisteEventoEnAñoActual){
    ...
    header('Location: ../../Vista/Academico/MiCuenta_CE.php');//Aqui lo redireccionas al lugar que quieras.    
}else{
?>
...
<head>
    ...
    <link rel="stylesheet" href="../../Assets/css/Academico/micuenta_se.css" >
