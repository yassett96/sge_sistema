...
<body>
    ...
    <div class="containerbotones">
        <div class="buttons-row">
            <button onclick="location.href='../../Vista/Academico/ReportesInscritoConfirmadosA.php'" class="button btn btnInCon" id="btnInCon">Inscritos confirmados</button>
            <button onclick="location.href='../../Vista/Academico/ReportesInscritoNoConfirmadoA.php'"class="button btn btnInNCon " id="btnInNCon">Inscritos no confirmados</button>
            <button onclick="location.href='../../Vista/Academico/ReportesInscritoAbandonadosA.php'"class="button btn btnInAba " id="btnInAba">Abandonados</button>
            <button onclick="location.href='../../Vista/Academico/ReportesParticipantesGeneralesA.php'"class="button btn btnInGenerales " id="btnInGenerales">Lista de proyectistas</button>
            <button onclick="location.href='../../Vista/Academico/ReportesProyectosGeneralesA.php'"class="button btn btnProGenerales " id="btnPrpGenerales">Lista de proyectos</button>
