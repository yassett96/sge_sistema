...
<body>
    ...
    <h4 class="h4">Reportes de comisiones</h4>

    <div id="contenedor"></div>
    <div class="containerbotones">
        <div class="buttons-row">
            <button class="button btn btnPlanTrabajoC" id="btnPlanTrabajoC">Plan de trabajo por comisión</button>
            <button class="button btn btnIntegranteC " id="btnIntegranteC">Integrantes por comisión</button>
