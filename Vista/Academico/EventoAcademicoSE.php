...
require_once ("../../Controlador/Coordinador/CEvento_CoordinadorSE.php");
    ...
    if($VerificarExistenciaEvento == CteExisteEventoEnAñoActual){
        ...
        header('Location: ../../Vista/Academico/EventoAcademicoCE.php');//Aqui lo redireccionas al lugar que quieras.    
    }else{
...
<head>
    ...
    <link rel="stylesheet" href="../../Assets/css/Academico/EventoAcademicoSE.css">

    <title>Evento Academico SE</title>
</head>
...
<body>
        ...
        <div class="menu_general">
            <ul class="nav justify-content-end">
                ...
                <div class="dropdown">
                    ...
                    <a href="../../Vista/Academico/MCuentaSE_A.php">Mi cuenta</a>
        ...
        <div class="main-header">
            ...
            <nav id="nav" class="main-nav">
                <div class="nav-links">
                    ...
                    <a class="link-item" href="../../Vista/Academico/HistorialAcademico.php">Historial de
                        Eventos</a>
    ...
    <h4 class="titulo">Último evento realizado</h4>

    <!--========== INICIO CARRUSEL ==========-->
    <div class="slideshow-container">
        <div class="mySlides fade1">
            <div class="numbertext"></div>
            <img src="../../Assets/imagenes/Noticias/feria 3.jpg" style="width:100%;">
            <div class="text"> </div>
        </div>
    ...
    <div class="contenedor">
        <ul class="nav nav-tabs nav-justified">
            <li class="nav-item">
                <a class="nav-link" aria-current="page" href="#pestaña1">Último evento</a>
            </li>
            <li class="nav-item">
