...
$ListaComisiones = $MRep->ObtenerProyectosConfirmadosEA();

$TotalProyectos = count($ListaComisiones);

$ListaParticipantes = $MRep->ObtenerParticipantesConfirmadosEA();
...
<body>
    ...
    <h4 class="h4">Proyectos y participantes inscritos confirmados</h4>
    ...
    $(document).ready(function() {
        ...
        var table = $('#TProyectosEA').DataTable({
            ...
            buttons: [{
                    ...
                    title: 'Proyectos Confirmados del Evento actual',
        ...
        table.on('click', 'tbody tr', function() {
            ...
            $.ajax({
                url: "../../Controlador/Coordinador/CCargarIntegrantesProyecto_Conf.php",
                type: "POST",
                data: {
        ...
        var table3 = $('#TParticipantesEA').DataTable({
            ...
            buttons: [{
                    extend: 'excelHtml5',
                    text: '<i class="fas fa-file-excel"></i> ',
                    title: 'Listado de Participantes Confirmados',
                    titleAttr: 'Exportar a Excel',
                    className: 'btn btn-success'
                },
                {
