...
require_once ("../../Controlador/Academico/CCuenta_CE.php");
...
if($VerificarExistenciaEvento != CteExisteEventoEnAñoActual){
    ...
    header('Location: ../../Vista/Academico/MiCuenta_SE.php');//Aqui lo redireccionas al lugar que quieras.    
}else{
...
<head>
    ...
    <link rel="stylesheet" href="../../Assets/css/Academico/micuenta_ce.css" >
...
<body>
    <header>
        ...
        <div class="menu_general">            
            <ul class="nav justify-content-end">                         
                <li class="nav-item"><a class="nav-link active" id="texto" href="../../Vista/Academico/InicioPersonalAcademico.php" >Inicio</a></li>
                <li class="nav-item"><a class="nav-link active" id="texto" href="">Eventos</a></li>
                <li class="nav-item"><a class="nav-link active" id="texto" href="">¿Qué es SGE-FCYS?</a></li>
                <li class="nav-item"><a href="">Comisiones </a>
                  <ul id="fondo">
                    <a id="FondoNav" href="../../Vista/Coordinador/Prox.php">Comisión asignada</a>
                    <a id="FondoNav" href="../../Vista/Coordinador/Prox.php">Comisiones generales</a>
                  </ul>
                </li>
                <li class="nav-item"><a class="nav-link active" id="texto" href="../../Vista/Coordinador/Prox.php">Reportes</a></li>                
                ...
                <div class="dropdown">
                    ...
                    <div class="dropdown-content">
                        <a href="../../Vista/Academico/MiCuenta_CE.php">Mi cuenta</a>
        ...
        <div class="main-header">            
            <nav id="nav" class="main-nav">
              <div class="nav-links">
                ...
                <a class="link-item"  href="">Eventos</a>
                <a class="link-item"  href="">¿Qué es SGE-FCYS?</a>
                <a class="link-item"  href="">Comisión asignada</a>
                <a class="link-item"  href="">Comisiones generales</a>                   
                <a class="link-item"  href="">Reportes</a>
                <a class="link-item"  href="../../Vista/Academico/MiCuenta_CE.php">Mi cuenta</a>
    ...
    <script type="text/javascript" src="../../Assets/js/Academico/micuenta_ce.js"></script>
    ...
    <footer class="site-footer">
      <div class="container">
        <div class="row">
          ...
          <div class="col-xs-6 col-md-3">
            <ul class="footer-links">
            <li><a href="../../Vista/Academico/MiCuenta_CE.php">Mi cuenta</a></li>
            </ul>
          </div>
