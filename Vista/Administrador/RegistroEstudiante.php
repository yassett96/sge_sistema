...
if ($_SESSION['PersonaAcademica']['ID_Tipo_Usuario']  != 6)  {
  ...
  $TiUs = new TipoUModel();
  $estudiante = new AdministracionEstudiantesModelo();
  ...
  // $listaGrupo = $estudiante->
  // $listaSedesInvitado = $invitado->FunObtenerSedesEstudiantes();
...
<head>
    ...
    <link rel="stylesheet" href="../../Assets/css/Administrador/RegistroEstudiantes.css">
...
<body onbeforeunload="return myFunction()">
    ...
    <h4 class="h4">Ingrese los datos para registrar al nuevo estudiante</h4>
    <div class="formulario_general">
        <form  id="form_general" name="form_general">
        <div id="Alerta"></div>
            <h4 class="h4_formulario">Estudiante</h4>
            ...
            <div  class="row">
                ...
                <div  class="row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" name="numeroCarnet" id="pInputNumeroCarnet" required maxlength="10" oninput="formatoCarnet(this)">
                ...
                <div  class="row"> 
                    ...
                    <label>Grupo(*)</label>
                    <select class="form-select" name="grupo"  id="selectGrupo"  onmousedown="if(this.options.length>3){this.size=3;}" onchange='this.size=0;' onblur="this.size=0;"  aria-label="Default select example">
...
function myFunction() {
  ...
  <script type="text/javascript" src="../../Assets/js/Administrador/AdministracionEstudiantes.js"></script> 
