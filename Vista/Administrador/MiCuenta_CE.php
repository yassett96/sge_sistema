...
if($VerificarExistenciaEvento != CteExisteEventoEnAñoActual){
    ...
    header('Location: ../../Vista/Administrador/MiCuenta_SE.php');//Aqui lo redireccionas al lugar que quieras.    
}else{
?>
...
<head>
    ...
    <link rel="stylesheet" href="../../Assets/css/Administrador/micuenta_ce.css" >
        ...
        <div class="menu_general">
            <ul class="nav justify-content-end">
                ...
                <div class="dropdown-content">
                    <a href="../../Vista/Administrador/MiCuenta_CE.php">Mi cuenta</a>
        ...
        <div class="main-header">            
            <nav id="nav" class="main-nav">
              <div class="nav-links">
                ...
                <a class="link-item" href="../../Vista/Coordinador/Prox.php">Comisión asignada</a>
