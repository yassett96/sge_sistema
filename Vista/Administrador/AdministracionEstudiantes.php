<?php
  ...
  require_once ("../../Controlador/Administrador/CAdministracionEstudiantes.php"); 
  ...
  $TiUs = new TipoUModel();
//   $invitado = new AdministracionEstudiantesModelo();
...
<head>
  ...
  <link rel="stylesheet" href="../../Assets/css/Administrador/AdministracionEstudiantes.css">
...
<body>
    ...
    <h1 id="h1TextoInicial">Administración estudiantes</h1>
    
    <br><br><br>
    
    <input type="Text" id="idSelectBusqueda" placeholder="Buscar estudiante" ></input>

    <br><br>

      <!-- INICIO TABLA -->
      <div id="idDivTabla">
        <h2 id="idTextoTabla">Seleccione el estudiante que desea administrar</h2>
      ...
      <div id="idDivBotonesAcciones">
        <button class="classBotonAccion" id="idBotonEliminar">Eliminar estudiante</button>
        <button class="classBotonAccion" id="idBotonEditar">Editar estudiante</button>
        <button class="classBotonAccion" id="idBotonCrear">Crear estudiante</button>
      </div>
      <br>
      <br>
      ...
      <div id="divFondoPopUpEditar">
        <div id="divPopUpEditar">
          <h1 id="textoEncabezadoPopUpEditar">Editar Estudiante</h1>
          <br>
          ...
          <!-- <section id="popUpEditarCampo3" class="popUpEditarCampos">
            <h5 class="h5TextosPopUpEditar">Cédula</h5>
            <input type="text" value="Email" class="camposPopUpEditar">
          </section> -->
   ...
   <script src="../../Assets/js/Administrador/AdministracionEstudiantes.js"></script>   
