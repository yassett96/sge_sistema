<?php
  ...
  require_once ("../../Controlador/Administrador/CAdministracionInvitado.php"); 
...
<head>
  ...
  <link rel="stylesheet" href="../../Assets/css/Administrador/AdministracionInvitado.css">
  
  <title>Administración invitado</title>
</head>
<body>
    <header>
        <div>    
    ...
    <h1 id="h1TextoInicial">Administración invitado</h1>
    
    <br><br><br>
    
    <input type="Text" id="idSelectBusqueda" placeholder="Buscar invitado" ></input>

    <br><br>

      <!-- INICIO TABLA -->
      <div id="idDivTabla">
        <h2 id="idTextoTabla">Seleccione el invitado que desea administrar</h2>
      ...
      <div id="idDivBotonesAcciones">
        <button class="classBotonAccion" id="idBotonEliminar">Eliminar invitado</button>
        <button class="classBotonAccion" id="idBotonEditar">Editar invitado</button>
        <button class="classBotonAccion" id="idBotonCrear">Crear invitado</button>
      </div>
      <br>
      <br>
      ...
      <div id="divFondoPopUpEditar">
        <div id="divPopUpEditar">
          <h1 id="textoEncabezadoPopUpEditar">Editar Invitado</h1>
          <br>
   ...
   <script src="../../Assets/js/Administrador/AdministracionInvitado.js"></script>   
