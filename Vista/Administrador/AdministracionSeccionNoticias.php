...
<head>
  ...
  <link rel="stylesheet" href="../../Assets/css/Administrador/AdministracionSeccionNoticias.css">
...
<body>
    ...
    <h1 id="h1TextoInicial">Gestión sección noticias</h1>
    <br>
    <br>
    <br>
    ...
    <div id="div_Contenedor_Noticias">
      <h3 id="idH3TextoContenedor">Seleccione la sección de noticia que desea modificar</h3>
      ...
      <section class="secNoti" id="sectionNoticiasDosTres">
        <div Class="div_Contenedor_Noticia_Secundario div1" id="div_Noticia_Secundario">
          <img src="">                
          <div class="div_Animacion2"><h3 style="color:white;" class="h3_Titulo_Noticia"></h3></div>
        </div>
        
        <div Class="div_Contenedor_Noticia_Secundario div2" id="div_Noticia_Terciario">
          <img src="">                
          <div class="div_Animacion3"><h3 style="color:white;" class="h3_Titulo_Noticia"></h3></div>
        </div> 
      </section>
    </div>
    ...
    <div id="idDivBotonesAcciones">
      <button class="classBotonAccion" id="idBotonEditar">Editar noticia</button>      
    </div>

    <!-- Inicio PopUp Editar -->
    <div id="divFondoPopUpEditar">
      <div id="divPopUpEditar">
        <h1 id="textoEncabezadoPopUpEditar">Editar noticia</h1>
        <br>
