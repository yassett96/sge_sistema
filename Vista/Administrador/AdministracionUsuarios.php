<?php
  ...
  require_once ("../../Controlador/Administrador/CAdministracionUsuarios.php"); 
...
<head>
  ...
  <link rel="stylesheet" href="../../Assets/css/Administrador/AdministracionUsuarios.css">
  
  <title>Administración accesos</title>
</head>
<body>
    <header>
        <div>    
    ...
    <h1 id="h1TextoInicial">Administración accesos</h1>
    
    <br><br><br>
    
    <input type="Text" id="idSelectBusquedaPA" placeholder="Buscar acceso" ></input>

    <br id="pinputContraseña"><br id="pInputRepContraseña"><!-- Coloque los id aquí para que no haya problemas al momento de hacer input de texto a los campos de contraseña del formulario de registrar un nuevo ususario, porque el mismo archvio js que se usa en esta vista -->

      <!-- INICIO TABLA -->
      <div id="idDivTabla">
        <h2 id="idTextoTabla">Seleccione el acceso que desea administrar</h2>
          ...
          <table id="idTable">
            <thead>
              <tr>
                ...
                <th>Cédula</th>
                <th>Sede participante</th>
                <th>Sede personal académico</th>
                <th>Grupo</th>
            ...
            <tbody>
              <?php 
                $vlocArrayListaPersonalAcademico = FunObtenerListaUsuarios();
      ...
      <div id="idDivBotonesAcciones">
        <button class="classBotonAccion" id="idBotonEliminar">Eliminar acceso</button>
        <button class="classBotonAccion" id="idBotonEditar">Editar datos</button>
      ...
      <div id="divFondoPopUpEditar">
        <div id="divPopUpEditar">
          <h1 id="textoEncabezadoPopUpEditar">Editar datos</h1>
          <br>
          <div id="divCamposEditarParticipante">
            ...
            <section id="popUpEditarCampo2" class="popUpEditarCampos">
              <h5 class="h5TextosPopUpEditar">Tipo acceso</h5>
              <select class="camposPopUpEditar" disabled>
                <?php echo $listaSelectTipoUsuario; ?>
              </select>
            </section>
            <section id="popUpEditarCampo3" class="popUpEditarCampos">
              <h5 class="h5TextosPopUpEditar">N° Carnet</h5>
              <input type="text" value="N° Carnet" class="camposPopUpEditar" disabled>
            </section>
            ...
            <section id="popUpEditarCampo7" class="popUpEditarCampos">
              <h5 class="h5TextosPopUpEditar">Grupo</h5>
              <select class="camposPopUpEditar">
          ...
          <div id="divCamposEditarPersonalAcademico">
            <section id="popUpEditarCampo1" class="popUpEditarCampos">
              <h5 class="h5TextosPopUpEditar">Nombres y apellidos</h5>
              <input type="text" value="Nombre y apellidos" class="camposPopUpEditar" disabled>
            </section>
            <section id="popUpEditarCampo2" class="popUpEditarCampos">
              <h5 class="h5TextosPopUpEditar">Tipo acceso</h5>
            ...
            <section id="popUpEditarCampo7" class="popUpEditarCampos">
              <h5 class="h5TextosPopUpEditar">Rol</h5>
              <select class="camposPopUpEditar">
                <?php echo $listaRoles; ?>
              </select>
            </section> 
            <section id="popUpEditarCampo4" class="popUpEditarCampos">
              ...
              <input type="text" value="Cargo" class="camposPopUpEditar">
            </section>
          </div>

          <div id="divCamposEditarGenerico">
            <section id="popUpEditarCampo1" class="popUpEditarCampos">
              <h5 class="h5TextosPopUpEditar">Nombres y apellidos</h5>
              <input type="text" value="Nombre y apellidos" class="camposPopUpEditar" disabled>
            </section>
      ...
      <div id="divFondoPopUpAgregar">
        <div id="divPopUpAgregar">
          <h1 id="textoEncabezadoPopUpAgregar">Agregar acceso</h1>
          <br>
          <section id="popUpAgregarCampo1" class="popUpAgregarCampos">
            <h5 class="h5TextosPopUpAgregar">Nombre y Apellidos</h5>
            <input type="text" value="Nombre y apellidos" class="camposPopUpAgregar" disabled>
          </section>
          <section id="popUpAgregarCampo2" class="popUpAgregarCampos">
            <h5 class="h5TextosPopUpAgregar">Tipo acceso</h5>
            <select class="camposPopUpAgregar">
              <?php //echo $listaSelectTipoUsuario; ?>
            </select>
          </section>

          <!-- Si el tipo de usuario es participante -->
          <section id="popUpAgregarCampo3" class="popUpAgregarCampos ocultaPar">
            <h5 class="h5TextosPopUpEditar">Sede</h5>
            <select class="camposPopUpAgregar">
              <?php echo $listaSedes; ?>
            </select>
          </section>             
          <section id="popUpAgregarCampo4" class="popUpAgregarCampos ocultaPar">
            <h5 class="h5TextosPopUpEditar">Grupo</h5>
            <select class="camposPopUpAgregar">
            <?php 
              $vlocListaGrupos = implode(',', $listaGrupos);
              echo $vlocListaGrupos;?>
            </select>
          </section> 
          <section id="popUpAgregarCampo9" class="popUpAgregarCampos ocultaPer">
            <h5 class="h5TextosPopUpAgregar">N° Carnet</h5>
            <input type="text" value="" class="camposPopUpAgregar">
          </section>

          <!-- Si el tipo de usuario es Personal Académico -->
          <section id="popUpAgregarCampo5" class="popUpAgregarCampos ocultaPer">
            <h5 class="h5TextosPopUpEditar">Sede</h5>
            <select class="camposPopUpAgregar">
              <?php echo $listaSedes; ?>
            </select>
          </section>             
          <section id="popUpAgregarCampo6" class="popUpAgregarCampos ocultaPer">
            <h5 class="h5TextosPopUpEditar">Grado académico</h5>
            <select class="camposPopUpAgregar">
              <?php echo $listaGradoAcademico; ?>
            </select>
          </section> 
          <section id="popUpAgregarCampo7" class="popUpAgregarCampos ocultaPer">
            <h5 class="h5TextosPopUpEditar">Roles</h5>
            <select class="camposPopUpAgregar">
              <?php echo $listaRoles; ?>
            </select>
          </section>
          <section id="popUpAgregarCampo8" class="popUpAgregarCampos ocultaPer">
            <h5 class="h5TextosPopUpAgregar">Cargo</h5>
            <input type="text" value="" class="camposPopUpAgregar">
          </section>
          
          <br>

          <button class="botonesPopUpAgregar" id="buttonAgregarUsuarioPopUpAgregar">Agregar acceso</button>
   ...
   <script src="../../Assets/js/Administrador/AdministracionUsuarios.js"></script>   
