...
<head>
  ...
  <link rel="stylesheet" href="../../Assets/css/Administrador/AdministracionCarruselEvento.css">
  
  <title>Gestión carrusel evento</title>
</head>
<body>
    <header>
        <div>    
    ...
    <h1 id="h1TextoInicial">Gestión carrusel evento</h1>
    <br>
    <br>
    <br>
   ...
   <script src="../../Assets/js/Administrador/AdministracionCarruselEvento.js"></script>   
