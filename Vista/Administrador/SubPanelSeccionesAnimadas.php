...
<head>
  ...
  <link rel="stylesheet" href="../../Assets/css/Administrador/SubPanelSeccionesAnimadas.css">
  
  <title>Panel secciones animadas</title>
</head>
<body>
    <header>
        <div>    
    ...
    <h1 id="h1TextoInicial">Panel secciones animadas</h1>
    ...
    <!--== INICIO BOTONES ==-->
      <div id="idDivBotones">
        <button class="boton-imagen">
          <img src="../../Assets/imagenes/Iconos/Sistema/Administrador/periodico.png" alt="" id="imgGPersonalAcademico"><br>
          <span>Gestionar sección noticias</span>
        </button>
        <button class="boton-imagen">
          <img src="../../Assets/imagenes/Iconos/Sistema/Administrador/carrusel_inicio_2.png" alt="" id="imgGUsuarios"><br>
          <span>Gestionar carrusel inicio</span>
        </button>
        <button class="boton-imagen">
          <img src="../../Assets/imagenes/Iconos/Sistema/Administrador/carrusel_evento.png" alt="" id="imgGNoticias"><br>
          <span>Gestionar carrusel evento</span>
        </button>
        <button class="boton-imagen">
          <img src="../../Assets/imagenes/Iconos/Sistema/Administrador/cronologia.png" alt="" id="imgGTablas"><br>
          <span>Gestionar línea tiempo</span>
        </button>
        <!-- <button class="boton-imagen">
   ...
   <script src="../../Assets/js/Administrador/SubPanelSeccionesAnimadas.js"></script>   
