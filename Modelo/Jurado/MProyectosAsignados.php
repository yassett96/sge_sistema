<?php 
    ...
    Class ProyectosAsignadosModelo{

        /**INICIO FUNCIONES PROPIAS DE LA CLASE */

        public function FunObtenerListaProyectosAsignados($vparIdPersona){
            $vlocListaProyectosAsignados = '';
            $vlocQuery = "Call Obtener_ProyectosAsignadosJurado(".$vparIdPersona.");";
