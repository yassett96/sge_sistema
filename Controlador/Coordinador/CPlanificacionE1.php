...
if(empty($_FILES['tFile'])) {
    ...
    $nombreBD1 = "NULL";
    $result = $PlanDG->get_insertar_evento($TipoE,$NombreE,$EsloganE,$nombreBD1,$HoraE,$FechaE,$LugarE);
    echo $result;
...
//Subida del archivo al server tomando el nombre que se genera de manera temporal y renombrandolo por la ruta donde estara
            $result = $PlanDG->get_insertar_evento($TipoE,$NombreE,$EsloganE,$nombreBD,$HoraE,$FechaE,$LugarE);
            echo $result;
