...
$(this.document).ready(function () {
    ...
    */
    ...
    $('#idSelectBusquedaPA').on('keyup', function () {
        ...
        const $tbody = $('#idTable tbody');
        const $rows = $tbody.find('tr');
    
        $rows.hide().sort(function(a, b) {
            ...
            palabrasClave.forEach(palabra => {
                if (textA.includes(palabra)) {
                    coincideA = true;
                }
    
                if (textB.includes(palabra)) {
                    coincideB = true;
                }
            });
    ...
    $("#idBotonGenerarGanadores").click(function(){
        window.location.href="../../Vista/Jurado/GenerarResultados.php";
    });
    ...
    //Acción al dar clic en 'Generar reporte'
    $("#idBotonGenerarReporte").click(function(){
        let idPersona = FunEjecutarAjax("../../Controlador/Jurado/CResultadosEvaluaciones.php?vparBoolObtenerIdPersona=" + true);
        let listaProyectosEvaluados = FunEjecutarAjax("../../Controlador/Jurado/CResultadosEvaluaciones.php?vparIdPersona=" + idPersona);
        
        var url = "../../Controlador/Jurado/CReporte_ResultadosEvaluaciones.php?" +
        "vparListaProyectosEvaluados=" + listaProyectosEvaluados;
