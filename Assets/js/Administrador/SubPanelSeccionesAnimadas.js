function CambiarTextoSegunAnchoPantalla(){ 
  ...
  $(this.document).ready(function() {
    ...
    */
    ...
    // Gestionar sección noticias
    $(".boton-imagen:eq(0)").click(function() {
      window.location.href = "../../Vista/Administrador/AdministracionSeccionNoticias.php";
    });
  
    // Gestionar sección carrusel inicio
    $(".boton-imagen:eq(1)").click(function() {
      window.location.href = "../../Vista/Administrador/AdministracionCarruselInicio.php";
    });
  
    // Gestionar sección carrusel evento
    $(".boton-imagen:eq(2)").click(function() {
      window.location.href = "../../Vista/Administrador/AdministracionCarruselEvento.php";
    });

    // Gestionar sección línea tiempo
    $(".boton-imagen:eq(3)").click(function() {
      window.location.href = "../../Vista/Administrador/AdministracionLineaTiempo.php";
    });
