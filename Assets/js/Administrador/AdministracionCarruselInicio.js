    ...
    */
    ...
    //Acciones
      ...
      $("#div_Contenedor_Primario").click(function () {
        ...
        numeroImagen = Cnt_Imagen_Carrusel_Inicio_1;
      ...
      $("#div_Noticia_Secundario").click(function () {
        ...
        numeroImagen = Cnt_Imagen_Carrusel_Inicio_2;
      ...
      $("#div_Noticia_Terciario").click(function () {
        ...
        numeroImagen = Cnt_Imagen_Carrusel_Inicio_3;
      ...
      $("#buttonGuardarCambiosPopUpEditar").click(function () {
        ...
        var vlocResultadoAjax = FunEjecutarAjax("../../Controlador/Administrador/CAdministracionCarruselInicio.php?" +
