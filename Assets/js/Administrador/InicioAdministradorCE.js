function CambiarTextoSegunAnchoPantalla(){ 
  ...
  if (vlocAnchoPantalla < 339){
    ...
    $("#h1TextoInicial").html("Sistema de gestión de eventos FCYS");
  } 
  
  // if(vlocAnchoPantalla <= 280){
  //   $("#h1TextoInicial").html("Sistema de Gestión <br> "
  //   +"&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"
  //   +" de Eventos FCYS");
  // }
}
...
$(this.document).ready(function() {
  ...
  */
  ...
  $(".boton-imagen:eq(0)").click(function() {
    window.location.href = "../../Vista/Jurado/InicioJurado.php";
  });

  $(".boton-imagen:eq(1)").click(function() {
    window.location.href = "../../Vista/Academico/InicioPersonalAcademico.php";
  });

  $(".boton-imagen:eq(2)").click(function() {
    window.location.href = "../../Vista/Coordinador/Index_Coordinador.php";
  });
  
  //Funciones

  function FunBotonSeleccionado(vparIdBoton){
    // alert("Entramos: " + vparIdBoton);
    $(vparIdBoton).css({
