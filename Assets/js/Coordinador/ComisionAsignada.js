...
$(document).ready(function () {
    ...
    $("#ComisionesAsig").change(function () {

        ValorID = $("#Id_Per").val();

        ComisionAsig = $("#ComisionesAsig").val();
        NombreComisionAsig = $("#ComisionesAsig option:selected").text();
        ...
        $.ajax({
            ...
            success: function (result) {
                ...
                $("#NombreComisionA").html(NombreComisionAsig);
                contentElement.style.display = "block";

                $.ajax({
                    url: "../../Controlador/Coordinador/CCargarDatosComisionA.php",
                    type: "POST",
                    data: { ComisionASel: ComisionAsig },
                    cache: false,
                    success: function (result) {
                        //alert(result);
                        $("#Resp1Comision").html(result);

                        $.ajax({
                            url: "../../Controlador/Coordinador/CCargarDatosComisionA2.php",
                            type: "POST",
                            data: { ComisionASel: ComisionAsig },
                            cache: false,
                            success: function (result) {
                                //alert(result);
                                $("#Resp2Comision").html(result);

                                $.ajax({
                                    url: "../../Controlador/Coordinador/CCargarDatosComisionA3.php",
                                    type: "POST",
                                    data: { ComisionASel: ComisionAsig },
                                    cache: false,
                                    success: function (result) {
                                        //alert(result);
                                        $("#Resp3Comision").html(result);
                                        $.ajax({
                                            url: "../../Controlador/Coordinador/CCargarActividadComision.php",
                                            type: "POST",
                                            data: { ComisionASel: ComisionAsig },
                                            cache: false,
                                            success: function (result) {
    ...
    $("#btnRealizarConsulta").click(function () {//Agregar Nueva categoria
        ...
        var Id_ComisionAsig = $("#ComisionesAsig").val();
        var Id_N_ComisionAsig = $("#ComisionesAsig option:selected").text();



        $.ajax({
            url: "../../Vista/Coordinador/Pop_RealizarSolictudE.php",
            type: "POST",
    ...
    $("#btnVerSolicitudes").click(function () {//Agregar Nueva categoria
        ...
        var ComisionAsig = $("#ComisionesAsig").val();
    ...
    $("#btnEstadoActividad").click(function () {
        ...
        $.ajax({
            ...
            success: function (result) {
                ...
                $.ajax({
                    url: "../../Vista/Coordinador/Pop_EditarEstadoAct.php",
                    type: "POST",
                    data: { Id_ComAsig: IdComAct },
                    cache: false,
                    success: function (result) {
    ...
    $("#btnSubirPlan").click(function () {
        ...
        $.ajax({
            url: "../../Vista/Coordinador/Pop_DescargarReporte.php",
            type: "POST",
            cache: false,
            success: function (result) {
                $("#contenedor").html(result);
    ...
    $("#btnAgregarActividad").click(function () {//Agregar Nueva categoria
        ...
        $.ajax({
            url: "../../Vista/Coordinador/Pop_AgregarActividad.php",
            type: "POST",
            data: { ComisionASel: IDComisionAsig },
            cache: false,
            success: function (result) {
                //alert(result)
                $("#contenedor").html(result);
    ...
    $("#btnSubirReporteF").click(function () {
        ...
        $.ajax({
            url: "../../Vista/Coordinador/Pop_SubirReporteFinal.php",
            type: "POST",
            cache: false,
            success: function (result) {
                $("#contenedor").html(result);
    ...
    window.onload = function () {
        if (performance.navigation.type === 2) {
            // 2 indica que la página se ha cargado a través del botón de retroceso del navegador
            location.reload(true); // Recarga la página forzadamente
        }
    };
